...
Yii::import('ext.nestedset.NestedSetBehavior');

class TreeBehavior extends NestedSetBehavior {
    /**
     ...
     */
    protected static function getRegisterIndex($node) {
     ...
     */
    protected function moveNode($sibling, $after = false, $aschild = false) {
        ...
        if ($movenode->getLeftValue() < $compare) // Moving down!
        {
        ...
        if ($lower > $upper) // This (only?) (always?) happens when trying to move a node to the place
